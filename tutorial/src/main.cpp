...
int main()
{
	...
	*/
	...
	// Chapter 2.8
	// Split the following program into two files (main.cpp, and input.cpp).
	// main.cpp should have the main function, and input.cpp should have the getInteger function
	/*
	#include <iostream>
